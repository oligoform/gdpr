...
$GLOBALS['TYPO3_CONF_VARS']['SYS']['Objects'][\TYPO3\CMS\IndexedSearch\Controller\SearchController::class] = array(
    'className' => \GeorgRinger\Gdpr\Xclass\SearchController::class
);
...
if (TYPO3_MODE === 'BE') {
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        'tx_gdpr_m1',
        '',
        ['Administration' => 'index,help,search,delete,disable,reenable,randomize,moduleNotEnabled,log,configuration'],
        [
            'access' => 'user,group',
